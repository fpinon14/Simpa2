HA$PBExportHeader$w_a_spb_terri.srw
$PBExportComments$--} Fen$$HEX1$$ea00$$ENDHEX$$tre d'accueil pour le param$$HEX1$$e900$$ENDHEX$$trage des territorialit$$HEX1$$e900$$ENDHEX$$s.
forward
global type w_a_spb_terri from w_a_spb_code_anc
end type
end forward

global type w_a_spb_terri from w_a_spb_code_anc
string title = "Accueil - Gestion des territorialit$$HEX1$$e900$$ENDHEX$$s"
end type
global w_a_spb_terri w_a_spb_terri
...
//* Libell$$HEX4$$e900090009000900$$ENDHEX$$:	Initialise Le type de code des territorialit$$HEX1$$e900$$ENDHEX$$s.
//* Commentaires	:	
//*				  
//*-----------------------------------------------------------------
...
/*----------------------------------------------------------------------------*/
Dw_1.isJointure = " AND sysadm.code.id_typ_code = '+TR'"
end on
...
//*					 	param$$HEX1$$e900$$ENDHEX$$trage des territorialit$$HEX1$$e900$$ENDHEX$$s.
//* Commentaires	:	
//*				  
//*-----------------------------------------------------------------
//* MAJ PAR		Date		Modification
...
pb_Interro.istInterro.sTitre 						= "Recherche des territorialit$$HEX1$$e900$$ENDHEX$$s"
...
/*------------------------------------------------------------------*/
This.isTitreLst = "Base : " + itrtrans.database + ". Liste des Territorialit$$HEX1$$e900$$ENDHEX$$s"
end on
...
on w_a_spb_terri.create
call super::create
end on

on w_a_spb_terri.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type pb_retour from w_a_spb_code_anc`pb_retour within w_a_spb_terri
end type

type pb_interro from w_a_spb_code_anc`pb_interro within w_a_spb_terri
end type

type pb_creer from w_a_spb_code_anc`pb_creer within w_a_spb_terri
end type

type dw_1 from w_a_spb_code_anc`dw_1 within w_a_spb_terri
end type
...
type pb_tri from w_a_spb_code_anc`pb_tri within w_a_spb_terri
end type

type pb_imprimer from w_a_spb_code_anc`pb_imprimer within w_a_spb_terri
end type
