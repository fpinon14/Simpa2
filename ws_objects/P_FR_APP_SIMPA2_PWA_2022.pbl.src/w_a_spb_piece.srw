HA$PBExportHeader$w_a_spb_piece.srw
$PBExportComments$--} Fen$$HEX1$$ea00$$ENDHEX$$tre d'accueil pour le param$$HEX1$$e900$$ENDHEX$$trage des pi$$HEX1$$e800$$ENDHEX$$ces $$HEX2$$e0002000$$ENDHEX$$r$$HEX1$$e900$$ENDHEX$$clamer.
forward
global type w_a_spb_piece from w_a_spb_code_anc
end type
end forward

global type w_a_spb_piece from w_a_spb_code_anc
string title = "Accueil - Gestion des pi$$HEX1$$e800$$ENDHEX$$ces"
end type
global w_a_spb_piece w_a_spb_piece
...
//* Libell$$HEX4$$e900090009000900$$ENDHEX$$:	Initialise Le type de code des pi$$HEX1$$e800$$ENDHEX$$ces.
//* Commentaires	:	
//*				  
//*-----------------------------------------------------------------
...
/*----------------------------------------------------------------------------*/
/* Indique sur quel code on travaille (Pi$$HEX1$$e800$$ENDHEX$$ce).                                */
/*----------------------------------------------------------------------------*/
Dw_1.isJointure = " AND sysadm.code.id_typ_code = '+PC'"
end on
...
//*					 	param$$HEX1$$e900$$ENDHEX$$trage des pieces.
//* Commentaires	:	
//*				  
//*-----------------------------------------------------------------
//* MAJ PAR		Date		Modification
...
pb_Interro.istInterro.sTitre 						= "Recherche des pi$$HEX1$$e800$$ENDHEX$$ces"
...
/*------------------------------------------------------------------*/
This.isTitreLst = "Base : " + itrtrans.database + ". Liste des Pi$$HEX1$$e800$$ENDHEX$$ces"
end on

on w_a_spb_piece.create
call super::create
end on

on w_a_spb_piece.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type pb_retour from w_a_spb_code_anc`pb_retour within w_a_spb_piece
end type

type pb_interro from w_a_spb_code_anc`pb_interro within w_a_spb_piece
end type

type pb_creer from w_a_spb_code_anc`pb_creer within w_a_spb_piece
end type

type dw_1 from w_a_spb_code_anc`dw_1 within w_a_spb_piece
end type
...
type pb_tri from w_a_spb_code_anc`pb_tri within w_a_spb_piece
end type

type pb_imprimer from w_a_spb_code_anc`pb_imprimer within w_a_spb_piece
end type
