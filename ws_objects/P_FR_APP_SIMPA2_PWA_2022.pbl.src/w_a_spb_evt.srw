HA$PBExportHeader$w_a_spb_evt.srw
$PBExportComments$--} Fen$$HEX1$$ea00$$ENDHEX$$tre d'accueil pour le param$$HEX1$$e900$$ENDHEX$$trage des $$HEX1$$e900$$ENDHEX$$v$$HEX1$$e800$$ENDHEX$$nements.
forward
global type w_a_spb_evt from w_a_spb_code_anc
end type
end forward

global type w_a_spb_evt from w_a_spb_code_anc
string title = "Accueil - Gestion des $$HEX1$$e900$$ENDHEX$$v$$HEX1$$e800$$ENDHEX$$nements"
end type
global w_a_spb_evt w_a_spb_evt
...
//* Libell$$HEX4$$e900090009000900$$ENDHEX$$:	Initialise Le type de code des $$HEX1$$e900$$ENDHEX$$v$$HEX1$$e800$$ENDHEX$$nements.
//* Commentaires	:	
//*				  
//*-----------------------------------------------------------------
...
/*----------------------------------------------------------------------------*/
/* Indique sur quel code on travaille (Ev$$HEX1$$e800$$ENDHEX$$nements).                           */
/*----------------------------------------------------------------------------*/
Dw_1.isJointure = " AND sysadm.code.id_typ_code = '+EV'"
end on
...
//*					 	param$$HEX1$$e900$$ENDHEX$$trage des $$HEX1$$e900$$ENDHEX$$v$$HEX1$$e800$$ENDHEX$$nements.
//* Commentaires	:	
//*				  
//*-----------------------------------------------------------------
//* MAJ PAR		Date		Modification
...
pb_Interro.istInterro.sTitre 						= "Recherche des Ev$$HEX1$$e800$$ENDHEX$$nements"
...
/*------------------------------------------------------------------*/
This.isTitreLst = "Base : " + itrtrans.database + ". Liste des Ev$$HEX1$$e800$$ENDHEX$$nements"
end on
...
on w_a_spb_evt.create
call super::create
end on

on w_a_spb_evt.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type pb_retour from w_a_spb_code_anc`pb_retour within w_a_spb_evt
end type

type pb_interro from w_a_spb_code_anc`pb_interro within w_a_spb_evt
end type

type pb_creer from w_a_spb_code_anc`pb_creer within w_a_spb_evt
end type

type dw_1 from w_a_spb_code_anc`dw_1 within w_a_spb_evt
end type
...
type pb_tri from w_a_spb_code_anc`pb_tri within w_a_spb_evt
end type

type pb_imprimer from w_a_spb_code_anc`pb_imprimer within w_a_spb_evt
end type
