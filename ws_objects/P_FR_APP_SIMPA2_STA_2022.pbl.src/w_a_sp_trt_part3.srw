HA$PBExportHeader$w_a_sp_trt_part3.srw
$PBExportComments$--- } Fen$$HEX1$$ea00$$ENDHEX$$tre de traitement particuliers 3 : Stat Hebdo pour SFR MUST (DNT) Temporairement
forward
...
long backcolor = 12632256
boolean enabled = false
string text = "SFR MUST (5712), Statistiques sur base r$$HEX2$$e900e900$$ENDHEX$$lle"
alignment alignment = center!
boolean border = true
boolean focusrectangle = false
end type
