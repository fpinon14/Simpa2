...
While @iTourGeneral <= 3 
 Begin
	...
	-- Mot à décoller
	Insert into @tbDecoll Values ( 'ACIER', 0 )
	Insert into @tbDecoll Values ( 'AKORA', 0 )
	Insert into @tbDecoll Values ( 'AMANDE', 0 )
	Insert into @tbDecoll Values ( 'AMBRE', 0 )
	Insert into @tbDecoll Values ( 'ANDROID', 0 )
	Insert into @tbDecoll Values ( 'ANTHRACITE', 0 )
	Insert into @tbDecoll Values ( 'AQUARIS', 0 )
	Insert into @tbDecoll Values ( 'ARABICA', 0 )
	Insert into @tbDecoll Values ( 'ARC-EN-CIEL', 0 )
	Insert into @tbDecoll Values ( 'ARDOISE LEGER', 0 )
	Insert into @tbDecoll Values ( 'ARDOISE', 0 )
	Insert into @tbDecoll Values ( 'ARGENT', 0 )
	Insert into @tbDecoll Values ( 'ARNOVA', 0 )
	Insert into @tbDecoll Values ( 'ASCEND', 0 )
	Insert into @tbDecoll Values ( 'ASHA', 0 )
	Insert into @tbDecoll Values ( 'ASPHALTE', 0 )
	Insert into @tbDecoll Values ( 'ASPIRE', 0 )
	Insert into @tbDecoll Values ( 'AUBERGINE', 0 )
	Insert into @tbDecoll Values ( 'AZUL', 0 )
	Insert into @tbDecoll Values ( 'AZUR', 0 )
	Insert into @tbDecoll Values ( 'BEIGE', 0 )
	Insert into @tbDecoll Values ( 'BETOUCH', 0 )
	Insert into @tbDecoll Values ( 'BLANC CASSE', 0 )
	Insert into @tbDecoll Values ( 'BLANC NACRE', 0 )
	Insert into @tbDecoll Values ( 'BLANC', 0 )
	Insert into @tbDecoll Values ( 'BLEU CLAIR', 0 )
	Insert into @tbDecoll Values ( 'BLEU FLAMBOYANT', 0 )
	Insert into @tbDecoll Values ( 'BLEU FONCE', 0 )
	Insert into @tbDecoll Values ( 'BLEU GLACIER', 0 )
	Insert into @tbDecoll Values ( 'BLEU GUIMAUVE', 0 )
	Insert into @tbDecoll Values ( 'BLEU INDIGO', 0 )
	Insert into @tbDecoll Values ( 'BLEU MARINE', 0 )
	Insert into @tbDecoll Values ( 'BLEU NUIT', 0 )
	Insert into @tbDecoll Values ( 'BLEU', 0 )
	Insert into @tbDecoll Values ( 'BORDEAUX', 0 )
	Insert into @tbDecoll Values ( 'BRONZE', 0 )
	Insert into @tbDecoll Values ( 'BRUN AMBRE', 0 )
	Insert into @tbDecoll Values ( 'CARBONE', 0 )
	Insert into @tbDecoll Values ( 'CHAMPAGNE', 0 )
	Insert into @tbDecoll Values ( 'CHARBON', 0 )
	Insert into @tbDecoll Values ( 'CHEFPAS', 0 )
	Insert into @tbDecoll Values ( 'CHILDPAD', 0 )
	Insert into @tbDecoll Values ( 'CHOCOLAT', 0 )
	Insert into @tbDecoll Values ( 'CIEL', 0 )
	Insert into @tbDecoll Values ( 'CITRON', 0 )
	Insert into @tbDecoll Values ( 'COBALT', 0 )
	Insert into @tbDecoll Values ( 'CONSTELLATION', 0 )
	Insert into @tbDecoll Values ( 'CORAIL', 0 )
	Insert into @tbDecoll Values ( 'COTON', 0 )
	Insert into @tbDecoll Values ( 'CREME', 0 )
	Insert into @tbDecoll Values ( 'CREMEUX', 0 )
	Insert into @tbDecoll Values ( 'CREPUSCULE', 0 )
	Insert into @tbDecoll Values ( 'CRISTAL', 0 )
	Insert into @tbDecoll Values ( 'CRYSTAL', 0 )
	Insert into @tbDecoll Values ( 'CUIVRE', 0 )
	Insert into @tbDecoll Values ( 'CYAN', 0 )
	Insert into @tbDecoll Values ( 'CYGNUS', 0 )
	Insert into @tbDecoll Values ( 'DARK CYAN', 0 )
	...
	Insert into @tbDecoll Values ( 'DORE SOLAIRE', 0 )
	...
	Insert into @tbDecoll Values ( 'FRAMBOISE', 0 )
	Insert into @tbDecoll Values ( 'GALAXY', 0 )
	Insert into @tbDecoll Values ( 'GALET', 0 )
	Insert into @tbDecoll Values ( 'GAME', 0 )
	Insert into @tbDecoll Values ( 'GRAPHITE', 0 )
	Insert into @tbDecoll Values ( 'GRENAT', 0 )
	Insert into @tbDecoll Values ( 'GRIS ARDOISE', 0 )
	Insert into @tbDecoll Values ( 'GRIS CACAO', 0 )
	Insert into @tbDecoll Values ( 'GRIS FONCE', 0 )
	Insert into @tbDecoll Values ( 'GRIS METALLISE', 0 )
	Insert into @tbDecoll Values ( 'GRIS', 0 )
	...
	Insert into @tbDecoll Values ( 'INDIGO', 0 )
	Insert into @tbDecoll Values ( 'INTERNET', 0 )
	Insert into @tbDecoll Values ( 'INTERSELLAIRE BRILLANT', 0 )
	Insert into @tbDecoll Values ( 'IPAD', 0 )
	Insert into @tbDecoll Values ( 'IPHONE', 0 )
	Insert into @tbDecoll Values ( 'IVOIRE', 0 )
	Insert into @tbDecoll Values ( 'JAUNE', 0 )
	Insert into @tbDecoll Values ( 'LAVANDE', 0 )
	Insert into @tbDecoll Values ( 'LENNY', 0 )
	Insert into @tbDecoll Values ( 'LIBERTO', 0 )
	Insert into @tbDecoll Values ( 'LILAS', 0 )
	Insert into @tbDecoll Values ( 'LIME', 0 )
	Insert into @tbDecoll Values ( 'LUBI', 0 )
	Insert into @tbDecoll Values ( 'LUMIA', 0 )
	Insert into @tbDecoll Values ( 'MAGENTA', 0 )
	Insert into @tbDecoll Values ( 'MARRON', 0 )
	Insert into @tbDecoll Values ( 'MAUVE', 0 )
	Insert into @tbDecoll Values ( 'MAYA', 0 )
	Insert into @tbDecoll Values ( 'MEMO', 0 )
	Insert into @tbDecoll Values ( 'MENTHE', 0 )
	Insert into @tbDecoll Values ( 'MERCURE LIQUIDE', 0 )
	Insert into @tbDecoll Values ( 'METEOR', 0 )
	Insert into @tbDecoll Values ( 'MINUIT', 0 )
	Insert into @tbDecoll Values ( 'MIROIR GRIS', 0 )
	Insert into @tbDecoll Values ( 'MOJITO', 0 )
	Insert into @tbDecoll Values ( 'NEIGE', 0 )
	Insert into @tbDecoll Values ( 'NEXUS', 0 )
	Insert into @tbDecoll Values ( 'NIGHT', 0 )
	Insert into @tbDecoll Values ( 'NOIR', 0 )
	Insert into @tbDecoll Values ( 'NULL', 0 )
	Insert into @tbDecoll Values ( 'OCEAN', 0 )
	Insert into @tbDecoll Values ( 'ODYSSEY', 0 )
	Insert into @tbDecoll Values ( 'OLIVE', 0 )
	Insert into @tbDecoll Values ( 'OPTIMUS', 0 )
	Insert into @tbDecoll Values ( 'OR LEGER', 0 )
	Insert into @tbDecoll Values ( 'OR ROSE', 0 )
	Insert into @tbDecoll Values ( 'OR', 0 )
	Insert into @tbDecoll Values ( 'ORANGE', 0 )
	Insert into @tbDecoll Values ( 'ORCHIDEE', 0 )
	Insert into @tbDecoll Values ( 'OUTREMER', 0 )
	Insert into @tbDecoll Values ( 'OXYGEN', 0 )
	Insert into @tbDecoll Values ( 'PAPRIKA', 0 )
	Insert into @tbDecoll Values ( 'PAVILION', 0 )
	Insert into @tbDecoll Values ( 'PECHE', 0 )
	Insert into @tbDecoll Values ( 'PLATINE', 0 )
	Insert into @tbDecoll Values ( 'PLATINIUM', 0 )
	Insert into @tbDecoll Values ( 'PLAY', 0 )
	Insert into @tbDecoll Values ( 'PORCELAINE', 0 )
	Insert into @tbDecoll Values ( 'POWER', 0 )
	Insert into @tbDecoll Values ( 'PROTECTION', 0 )
	Insert into @tbDecoll Values ( 'PRUNE', 0 )
	Insert into @tbDecoll Values ( 'PURPLE', 0 )
	Insert into @tbDecoll Values ( 'RAINBOW', 0 )
	Insert into @tbDecoll Values ( 'RETINA', 0 )
	Insert into @tbDecoll Values ( 'ROCOCO PEARL', 0 )
	Insert into @tbDecoll Values ( 'ROSE', 0 )
	Insert into @tbDecoll Values ( 'ROUGE TORINO', 0 )
	Insert into @tbDecoll Values ( 'ROUGE', 0 )
	Insert into @tbDecoll Values ( 'SABLE', 0 )
	Insert into @tbDecoll Values ( 'SARCELLE', 0 )
	Insert into @tbDecoll Values ( 'SAUGE', 0 )
	...
	Insert into @tbDecoll Values ( 'SOMBRE LUNE', 0 )
	Insert into @tbDecoll Values ( 'SOMBRE NUIT', 0 )
	Insert into @tbDecoll Values ( 'SOMBRE OBSCUR', 0 )
	Insert into @tbDecoll Values ( 'SOMBRE TOTAL', 0 )
	Insert into @tbDecoll Values ( 'SOMBRE', 0 )
	...
	Insert into @tbDecoll Values ( 'SUPERNOVA', 0 )
	Insert into @tbDecoll Values ( 'SURFACE', 0 )
	Insert into @tbDecoll Values ( 'THUNDER', 0 )
	Insert into @tbDecoll Values ( 'TITANE BLANC', 0 )
	Insert into @tbDecoll Values ( 'TITANE BLEU', 0 )
	Insert into @tbDecoll Values ( 'TITANE GRIS', 0 )
	Insert into @tbDecoll Values ( 'TITANE NATUREL', 0 )
	Insert into @tbDecoll Values ( 'TITANE NOIR', 0 )
	Insert into @tbDecoll Values ( 'TITANE SABLE', 0 )
	Insert into @tbDecoll Values ( 'TITANE', 0 )
	Insert into @tbDecoll Values ( 'TITANIUM', 0 )
	Insert into @tbDecoll Values ( 'TLINK', 0 )
	Insert into @tbDecoll Values ( 'TOUCH', 0 )
	Insert into @tbDecoll Values ( 'TRANSPARENT', 0 )
	Insert into @tbDecoll Values ( 'TREKKER', 0 )
	Insert into @tbDecoll Values ( 'TROOPER', 0 )
	Insert into @tbDecoll Values ( 'TURQUOISE', 0 )
	Insert into @tbDecoll Values ( 'ULTRA', 0 )
	Insert into @tbDecoll Values ( 'VANILLE', 0 )
	Insert into @tbDecoll Values ( 'VENUS', 0 )
	Insert into @tbDecoll Values ( 'VERT CLAIR', 0 )
	Insert into @tbDecoll Values ( 'VERT D EAU', 0 )
	Insert into @tbDecoll Values ( 'VERT SAUGE', 0 )
	Insert into @tbDecoll Values ( 'VERT', 0 )
	Insert into @tbDecoll Values ( 'VIOLET', 0 )
...
--------------------------------------------------------------------
--
-- Procedure            :       PS_S_MOTEUR_RECH_IFR_EXTRANET
-- Auteur               :       JFF
-- Date                 :       29/09/2015
-- Libelle              :       
-- Commentaires         :       
...
-- 
-------------------------------------------------------------------
IF EXISTS ( SELECT * FROM sysobjects WHERE name = 'PS_S_MOTEUR_RECH_IFR_EXTRANET' AND type = 'P' )
        DROP procedure sysadm.PS_S_MOTEUR_RECH_IFR_EXTRANET
GO

CREATE procedure sysadm.PS_S_MOTEUR_RECH_IFR_EXTRANET
	@asChaineRech VarChar ( 100 )
AS
...
Insert into @TbWork Exec sysadm.PS_S_MOTEUR_RECH_IFR @asChaineRech, 'JAI_DE_LA_CHANCE'
Insert into @TbWork Exec sysadm.PS_S_MOTEUR_RECH_IFR @asChaineRech, 'MOTS_CLES'
Insert into @TbWork Exec sysadm.PS_S_MOTEUR_RECH_IFR @asChaineRech, 'MOTS_CLES_PLUS'

Select Distinct marque, modele from @TbWork order by 1,2
